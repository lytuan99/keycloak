...
public class FacebookPostLoginAuthenticatorFactory implements AuthenticatorFactory {
    public static final String PROVIDER_ID = "facebook-post-login";
