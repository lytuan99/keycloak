 ...
 */
public class VbeeCreateUserIfUniqueAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "vbee-create-user-if-unique";
    static VbeeCreateUserIfUniqueAuthenticator SINGLETON = new VbeeCreateUserIfUniqueAuthenticator();
    ...
    public String getDisplayType() {
        return "Vbee Create User If Unique";
    }
